...
class Redis
{
     ...
     * @param int $fd
     *
     * 内部存储的将会是一个对象 json ，格式如下：
     * "{extranet_ip: "47.88.223.82" , client_id: 1}"
     *
     * @var set 集合
     */
     ...
     *
     * @param string $identifier
     * @param string $extranet_ip
     * @param int $fd
     *
     * @var string
     */
    protected static $fdMappingUserId = '%s_fd_mapping_user_id_%s_%s';
     ...
     * @var string
     */
    protected static $fdMappingIdentifier = 'fd_mapping_identifier_%s_%s';
     ...
     * @var string
     */
    protected static $fdMappingPlatform = '%_fd_mapping_platform_%s_%s';
